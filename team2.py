...
strategy_name = 'collude then betray twice'
strategy_description = 'In this strategy, the player will start off by colluding and then betray for the next two moves. After the two betrays, they will collude again'
...
strategy_name = 'return opposite'
strategy_description = 'If the opponent betrays, then collude next round. If the opponent colludes, then betray the next round. first round is collude.'
